# Generated by Django 2.1.2 on 2018-12-15 08:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Player',
            fields=[
                ('player_name', models.CharField(default='', max_length=20, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Team',
            fields=[
                ('team_name', models.CharField(default='', max_length=20, primary_key=True, serialize=False)),
                ('team_city', models.CharField(default='', max_length=20)),
                ('coach', models.CharField(default='', max_length=20)),
                ('manager', models.CharField(default='', max_length=20)),
                ('arena', models.CharField(default='', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ('user_id', models.CharField(default='', max_length=20, primary_key=True, serialize=False)),
